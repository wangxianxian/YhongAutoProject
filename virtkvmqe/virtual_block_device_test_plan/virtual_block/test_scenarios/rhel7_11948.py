"""
RHEL7-11948 - [virtual block] check the file md5 value steady before and after block_resize
https://polarion.engineering.redhat.com/polarion/redirect/project/RedHatEnterpriseLinux7/workitem?id=RHEL7-11948
"""
import time
import re
...
def run_case(params):
    ...
    test = CREATE_TEST(case_id='rhel7_11948', guest_name=guest_name, timeout=600)
    id = test.get_id()
