"""
RHEL7-11912 - [virtual block] do "system_reset" when guest boot for at least 10 times
https://polarion.engineering.redhat.com/polarion/redirect/project/RedHatEnterpriseLinux7/workitem?id=RHEL7-11912
"""
...
def run_case(params):
    ...
    test = CREATE_TEST(case_id='rhel7_11912', guest_name=guest_name, timeout=600)
    id = test.get_id()
