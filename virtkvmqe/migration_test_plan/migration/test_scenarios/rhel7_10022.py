...
def run_case(params):
    ...
    test = CREATE_TEST(case_id='rhel7_10022', params=params, guest_name=guest_name, dst_ip=DST_HOST_IP, timeout=1800)
    id = test.get_id()
    ...
    dst_remote_qmp = RemoteQMPMonitor_v2(id, params, SRC_HOST_IP, qmp_port)
    while True:
